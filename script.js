  ...
  constructor() {
    ...
    this.translations = {
      zh: {
        ...
        "nav.notice": "说明",
        "message.title": "纪念留言",
        "message.subtitle": "在这里分享您对他最深切的思念。",
        "message.placeholder": "在这里分享您的思念...",
        "message.submit": "发布",
        ...
        "intro.quote":
          "你是一个拥有纯净，善良，正直之心的人，你值得被更多的人喜欢",
        "works.title": "影视作品",
        "works.role": "饰演",
        "media.title": "MV作品",
        "media.noVideo": "您的浏览器不支持视频播放",
        "media.playlist": "MV列表",
        "music.title": "音乐作品",
        "music.noSong": "未选择歌曲",
        "music.playlist": "歌曲列表",
        ...
        "flower.title": "送花",
        "flower.btn6": "送 6 朵花",
        "flower.btn15": "送 15 朵花",
        "flower.limit": "今天最多只能送",
        "flower.remaining": "朵花",
        "flower.unit": "朵",
        "flower.counter": "今日已送：",
        "flower.total": "送花总数：",
        "flower.limit.reached":
          "今天最多只能送 {max} 朵花，您还可以送 {remaining} 朵",
        "flower.error.failed": "送花失败，请稍后重试",
        "flower.error.invalid": "送花数量无效",
        "notice.title": "网站说明",
        "notice.section1.title": "1. 网站目的",
        "notice.section1.content": "该网站的目的是为了纪念朦胧，非赢利性网站。",
        "notice.section2.title": "2. 留言规范",
        "notice.section2.content":
          "请各位用户妥善留言，不要发布敏感词汇或者是任何涉及言语攻击、暴力等内容。",
        "notice.section3.title": "3. 资源来源",
        "notice.section3.content":
          "图片、音乐和视频都是我从网络上下载的，不会另作他用，只是为了留作纪念。",
        "notice.section4.title": "4. 版权声明",
        "notice.section4.content":
          "部分MV作品是从YouTube下载的，原创者如果觉得不妥，可以联系我，我会及时删除。",
        "notice.section5.title": "5. 征集投稿",
        "notice.section5.content":
          "我手里的资源十分有限，在这里诚心征集更多网友们的投稿，图片、视频等不限，我希望能够合力将这个网站做得更好。",
        "notice.section6.title": "6. 联系方式",
        "notice.section6.content":
          "以下是我的联系方式，如果有投稿请发送到我的邮箱，谢谢大家！",
      ...
      en: {
        ...
        "nav.notice": "Notice",
        "message.title": "Memorial Messages",
        "message.subtitle": "Share your memories and thoughts here.",
        "message.placeholder": "Share your thoughts here...",
        "message.submit": "Post",
        ...
        "intro.bio":
          "Mainland Chinese actor, singer, and MV director, born in Xinjiang.",
        "intro.quote":
          "A pure heart, a gentle spirit, and a steadfast sense of right — these were always you.",
        "works.title": "Film & TV",
        "works.role": "Role",
        "media.title": "MV Works",
        "media.noVideo": "Browser does not support video",
        "media.playlist": "Playlist",
        "music.title": "Musical Works",
        "music.noSong": "No song selected",
        ...
        "music.prev": "Previous",
        "music.next": "Next",
        "flower.title": "Send Flowers",
        "flower.btn6": "Send 6 Flowers",
        "flower.btn15": "Send 15 Flowers",
        "flower.limit": "You can only send",
        "flower.remaining": " more flowers",
        "flower.unit": " flowers",
        "flower.counter": "Today sent: ",
        "flower.total": "Total sent: ",
        "flower.limit.reached":
          "You can only send {max} flowers today. You can still send {remaining} more",
        ...
        "notice.section1.title": "1. Website Purpose",
        "notice.section1.content":
          "This website is created to commemorate Alan Yu. It is a non-profit website.",
        "notice.section2.title": "2. Message Guidelines",
        "notice.section2.content":
          "Please be respectful. No sensitive or offensive content.",
        "notice.section3.title": "3. Resource Sources",
        "notice.section3.content":
          "All media is downloaded from the internet for memorial purposes only.",
        "notice.section4.title": "4. Copyright Notice",
        "notice.section4.content":
          "Some content is from YouTube. Contact me for removal if inappropriate.",
        "notice.section5.title": "5. Content Submission",
        "notice.section5.content":
          "I welcome submissions from fans to make this website better.",
        "notice.section6.title": "6. Contact Information",
        "notice.section6.content": "Please send submissions to my email below.",
        "notice.email.label": "Email: ",
        "footer.copyright": "© 2025 于朦胧纪念网站 | Alan Yu Memorial Website",
        "footer.license":
          "This is a non-profit memorial website, for memorial purposes only",
      },
    };
    this.init();
  }
...
class ModalManager {
  ...
  initMobileMenu() {
    ...
    mobileMenuBtn.addEventListener("click", () => {
      ...
      document.body.style.overflow = navRight.classList.contains("mobile-open")
        ? "hidden"
        : "";
    });
...
class ImageCarousel {
  ...
  init() {
    ...
    this.autoPlayTimer = setInterval(() => {
      if (!this.isTransitioning && !this.isDragging) this.move(1);
    }, 5000);
  }
    ...
    this.wrapper.addEventListener(
      ...
      (e) => {
        ...
        if (this.touchDirection === "horizontal" && absDeltaX > 10) {
          ...
          this.touchDirection === "vertical" ||
          (this.touchDirection === null && absDeltaY > absDeltaX)
        ) {
...
class MessageBoard {
  ...
  async submit() {
    ...
    if (!text) {
      alert(
        languageManager ? languageManager.t("message.empty") : "请输入留言内容",
      );
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        alert(
          languageManager
            ? languageManager.t("message.submitted")
            : "留言已提交，等待审核通过后将显示。",
        );
        // 清除留言列表缓存，强制刷新
        const apiEndpoint =
  ...
  render() {
    ...
    this.wrapper.innerHTML = sortedMessages
      .map(
        (m) => `
...
class FlowerSection {
  ...
  async send(num) {
    ...
    try {
      ...
      if (typeof apiCache !== "undefined") {
        const timezoneOffset = -new Date().getTimezoneOffset();
        apiCache.clear(
          `${apiEndpoint}/flowers/today?timezoneOffset=${timezoneOffset}`,
          {
  ...
  updateUI() {
    if (languageManager) {
      document.getElementById("flowerBtn6").textContent =
        languageManager.t("flower.btn6");
      document.getElementById("flowerBtn15").textContent =
        languageManager.t("flower.btn15");
      this.updateDisplay();
    }
  }
}
...
class MusicPlayer {
  constructor() {
    ...
    this.songs = [
      {
        name: "那些你教我的事",
        src: "music/那些你教我的事.mp3",
        cover: "images/covers/那些你教我的事.png",
      },
      {
        name: "梦未完待续",
        src: "music/梦未完待续.mp3",
        cover: "images/covers/梦未完待续.png",
      },
      {
        name: "你早就知道",
        src: "music/你早就知道.mp3",
        cover: "images/covers/你早就知道.png",
      },
      { name: "镜", src: "music/镜.mp3", cover: "images/covers/镜.png" },
      {
        name: "月朦胧鸟朦胧",
        src: "music/月朦胧鸟朦胧.mp3",
        cover: "images/covers/月朦胧鸟朦胧.png",
      },
      { name: "星火", src: "music/星火.mp3", cover: "images/covers/星火.png" },
      {
        name: "只怪相遇太美丽",
        src: "music/只怪相遇太美丽.mp3",
        cover: "images/covers/只怪相遇太美丽.png",
      },
      {
        name: "一个人过",
        src: "music/一个人过.mp3",
        cover: "images/covers/一个人过.png",
      },
      ...
      {
        name: "我的世界只能容下一个你",
        src: "music/我的世界只能容下一个你.mp3",
        cover: "images/covers/我的世界只能容下一个你.png",
      },
    ];
  ...
  renderList() {
    document.getElementById("playlist").innerHTML = this.songs
      .map(
        (s, i) => `
...
class FilmWorksManager {
    ...
    this.works = [
      {
        title: "太子妃升职记",
        role: "九王齐翰",
        image: "images/works/九王.jpg",
      },
      {
        title: "三生三世十里桃花",
        role: "白真",
        image: "images/works/白真.jpg",
      },
      {
        title: "轩辕剑之汉之云",
        role: "徐暮云",
        image: "images/works/徐暮云.jpg",
      },
      { title: "霍去病", role: "李敢", image: "images/works/李敢.jpg" },
      {
        title: "凉生, 我们可不可以不忧伤",
        role: "程天恩",
        image: "images/works/程天恩.jpg",
      },
  ...
  render() {
    ...
    const roleLabel = languageManager
      ? languageManager.t("works.role")
      : "饰演";
    this.grid.innerHTML = this.works
      .map(
        (w) => `
            <div class="work-card">
...
class AdminManager {
    ...
    try {
      ...
      if (result.success && result.token) {
        ...
        if (this.failedAttempts >= this.maxAttempts) {
          ...
          errorEl.textContent =
            result.error || `密码错误，还有 ${remainingAttempts} 次尝试机会`;
          errorEl.style.display = "block";
          setTimeout(() => {
            errorEl.style.display = "none";
          }, 3000);
  ...
  async renderAdminMessages() {
    ...
    try {
      ...
      if (listEl) {
        ...
        listEl.innerHTML = sortedMessages
          .map((msg) => {
            const statusText =
              msg.status === "pending"
                ? "（待审核）"
      ...
      if (listEl) {
        listEl.innerHTML =
          '<p class="admin-error">获取留言失败，请刷新重试</p>';
      }
    }
  }
  ...
  async renderAdminFlowers() {
    ...
    try {
      ...
      // 获取筛选条件
      const dateFilter =
        document.getElementById("adminFlowerDateFilter")?.value || "";
      const ipFilter =
        document.getElementById("adminFlowerIpFilter")?.value || "";
      ...
      const response = await fetch(
        `${apiEndpoint}/flowers/records?${params.toString()}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${this.adminToken}`,
      ...
      if (listEl) {
        listEl.innerHTML =
          '<p class="admin-error">获取送花记录失败，请刷新重试</p>';
      }
    }
  }
